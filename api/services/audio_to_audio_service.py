...
def convert_audio_to_audio(file, input_body):
    """Convert audio file to specified audio format"""
    ...
    try:
        ...
        if 'input_format' in convert_task and 'output_format' in convert_task:
            input_format = convert_task.get('input_format', 'mp3').lower()
        ...
        # Trim audio (start/end time) - handle both cut_start/cut_end and trim_start/trim_end
