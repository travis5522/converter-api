...
from api.services.video_to_video_service import convert_video
import json

video_to_video_bp = Blueprint('video_to_video', __name__)

@video_to_video_bp.route('/video-to-video', methods=['POST'])
def video_to_video():
    ...
    try:
        ...
        result = convert_video(file, input_body)
